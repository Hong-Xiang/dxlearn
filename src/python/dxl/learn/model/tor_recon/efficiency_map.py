...
def efficiency_map(lors: Dict[str, Tensor], image_info: ImageInfo):
    ...
    grids = {
        ...
        'z':
        tf.constant(np.array(grid, np.int32), name='gridz'),
    }
    centers = {
        'x':
        tf.constant(
            np.array([center[1], center[2], center[0]], np.float32),
            name='centerx'),
        'y':
        tf.constant(
            np.array([center[0], center[2], center[1]], np.float32),
            name='centery'),
        'z':
        center,
    }
