...
public:
	explicit Projection(OpKernelConstruction *context) : OpKernel(context)
	{
		...
		OP_REQUIRES_OK(context, context->GetAttr("center", &center));
...
class BackprojectionGpu : public OpKernel
{
public:
	explicit BackprojectionGpu(OpKernelConstruction *context) : OpKernel(context)
	{
		OP_REQUIRES_OK(context, context->GetAttr("grid", &grid));
		OP_REQUIRES_OK(context, context->GetAttr("center", &center));
		OP_REQUIRES_OK(context, context->GetAttr("size", &size));
